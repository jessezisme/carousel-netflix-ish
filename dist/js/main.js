...
function Carousel(options) {
  ...
  var getSiblingsAndSelf = function getSiblingsAndSelf(elem) {
    // Setup siblings array and get the first sibling
    var siblings = [];
    var sibling = elem.parentNode.firstChild; // Loop through each sibling and push to the array
  ...
  function removeActiveItem() {
    ...
    Array.prototype.forEach.call(elListItems, function (el, index) {
      ...
      el.getAttribute("data-carousel-active") && el.removeAttribute("data-carousel-active"); // el.getAttribute("data-carousel-move") && el.removeAttribute("data-carousel-move");
  ...
  */
  ...
  function addEventListener(getEl, getEventName, getCallback) {
    ...
    eventArray.push(eventObj); // add event to element
  ...
  */
  ...
  function initEventListeners() {
    Array.prototype.forEach.call(elListItems, function (el, index) {
      // mouseenter
      addEventListener(el, "mouseenter", mouseenterEvent); // mouseleave
  ...
  return {
    ...
    reInitialize: function reInitialize(getOptions) {
      if (getOptions) {
        options = getOptions;
        this.initialize();
      }
    },
    goTo: function goTo(getWhere) {
      goToItem(getWhere);
    },
